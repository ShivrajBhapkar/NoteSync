                ...
                <div className="flex sm:flex-row flex-col w-full gap-10 my-8">
                    <div className="flex-1 flex flex-col gap-4">
                        ...
                        <p className="text-gray-500 sm:text-base text-lg">
                            Writing notes by hand not only requires a
                            substantial amount of time but also leaves room for
                            error. With our app, you save time, eliminate the
                            need for rewriting, and ensure the accuracy of your
                            notes.
                        </p>
                    </div>
                    <div className="flex-1 flex flex-col gap-4">
                        ...
                        <p className="text-gray-500 sm:text-base text-lg">
                            Unlike traditional paper notes, our digital notes
                            are editable. Made a mistake or want to refine your
                            understanding? No problem. You can easily edit your
                            notes to perfection, giving you complete control
                            over your learning material.
                        </p>
                    </div>
                    <div className="flex-1 flex flex-col gap-4">
                        <AllSizes />
                        ...
                        <p className="text-gray-500 sm:text-base text-lg">
                            ...
                            moment in a video when a crucial concept is
                            explained? Now you can. Our application allows you
                            to create timestamped notes, ensuring you capture
                            important information without the need for constant
            ...
            >
                <div className="flex flex-col gap-4 sm:w-5/12 px-8 self-center py-10">
                    ...
                    <p className="text-gray-200 sm:text-base text-lg">
                        Access your notes from anywhere, on any device. No need
                        to carry around heavy notebooks; your learning materials

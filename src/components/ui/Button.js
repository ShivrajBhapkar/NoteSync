...
const Button = ({ onClick, label, action }) => {
    ...
    const buttonStyles = {
        primary:
            "w-full bg-blue-500 text-white font-bold rounded-md lg:py-2 xl:py-2 md:py-2 lg:px-4 xl:px-4 md:px-4 mb-2 md:ml-2 lg:ml-2 xl:ml-2 px-4 py-2 pl-0 ",
        secondary:
            "w-full  border border-red-400 text-red-400 font-bold rounded-md lg:py-2 xl:py-2 md:py-2 lg:px-4 xl:px-4 md:px-4 mb-2 md:ml-2 lg:ml-2 xl:ml-2 px-4 py-2 pl-0 ",
